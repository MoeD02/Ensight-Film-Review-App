...
const MovieLanding = () => {
    ...
    const moviesArray = Array.from({ length: totalMovies }, (_, index) => index + 1);
        ...
        <div className="ListLandingPage">
            ...
            <div className="ListInformation">
                ...
                <div className="ListInteraction">
                    ...
                    <img className="Symbol h5Text" src={Comment} alt="like" width={35} height={32}/>
                    <h4>Comments</h4>
                </div>
            </div>
            <div className="ListMovieGrid">
                {moviesArray.map((movieNumber) => (
                    <span key={movieNumber} className="ListPoster">Movie {movieNumber}</span>
                ))}
            </div>
