        ...
        const fetchData = async () => {
            ...
            if (token) {
                ...
                try {
                    ...
                    console.log("This is the current logged in user's id: "+  currentUser.id+ " And this is the Profile we are on's id: "+  id );
                    if (typeof currentUser.id === 'string' && id.trim() === currentUser.id.trim()){
                        setIsMyPage(true);
