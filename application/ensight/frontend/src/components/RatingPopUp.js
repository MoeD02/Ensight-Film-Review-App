...
const RatingPopup = ({ title }) => {
    ...
    return (
        <div>
            <h5 className="MovieUserRate" onClick={openModal}>Rate</h5>
            <Modal
                isOpen={modalIsOpen}
            ...
            >
                <div className='RatingPopUp'>
                    <img className="MovieSymbol CloseRatingSymbol" src={RedX} alt="close" width={25} height={25} onClick={closeModal}/>
                    <div className='RatingStarQuestion'>
                        <img className="MovieSymbol" src={StarFilled} alt="star" width={100} height={95}/>
                    ...
                    <button className="Button RatingButton" onClick={handleRateSubmit}>Rate</button>
                </div>
            </Modal>
        </div>
    );
