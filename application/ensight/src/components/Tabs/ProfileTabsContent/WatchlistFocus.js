                ...
                {isEditing ? (
                    ...
                    <>
                        ...
                        <div className="WatchlistResults">
                            <div>
                                <button className="MovieWatchlist WatchButton" onClick={handleSubmitClick}>
                                    Movie
                                </button>
                                <h4 className="MovieText">Movie Title</h4>
                            </div>
                            <div>
                                <button className="MovieWatchlist WatchButton" onClick={handleSubmitClick}>Movie</button>
                                <h4 className="MovieText">Movie Title</h4>
                            </div>
                            <div>
                                <button className="MovieWatchlist WatchButton" onClick={handleSubmitClick}>Movie</button>
